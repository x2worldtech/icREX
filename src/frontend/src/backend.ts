...
export interface backendInterface {
    __highScores(ko: string | null, count: bigint | null): Promise<Array<[string, bigint]>>;
...
export class Backend implements backendInterface {
    ...
    async __highScores(arg0: string | null, arg1: bigint | null): Promise<Array<[string, bigint]>> {
        if (this.processError) {
            try {
                const result = await this.actor.__highScores(to_candid_opt_n1(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n2(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
